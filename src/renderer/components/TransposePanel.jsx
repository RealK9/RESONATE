    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          {semitones !== 0 && enabled && (
            <span style={{ fontSize: 9, fontFamily: MONO, color: "#D946EF", fontWeight: 700 }}>{semiLabel} st</span>
          )}
        </div>
        <button
          onClick={onToggle}
          style={{
            ...
            background: enabled ? "#D946EF" : (isDark ? "rgba(255,255,255,0.1)" : "rgba(0,0,0,0.1)"),
      ...
      <div style={{ display: "flex", gap: 0, marginBottom: 6, borderRadius: 4, overflow: "hidden", border: "1px solid " + theme.borderLight }}>
        <button
          ...
          style={{
            ...
            background: useFlats ? (isDark ? "rgba(217,70,239,0.12)" : "rgba(217,70,239,0.08)") : "transparent",
            color: useFlats ? "#D946EF" : theme.textMuted, cursor: "pointer", fontFamily: AF,
          }}
        >FLATS</button>
        <button
          ...
          return (
            <button
              ...
              style={{
                ...
                background: isTarget
                  ? "linear-gradient(135deg, rgba(217,70,239,0.25), rgba(139,92,246,0.2))"
                  : (isDark ? "rgba(255,255,255,0.04)" : "rgba(0,0,0,0.03)"),
                color: isTarget ? "#D946EF" : isUpload ? "#06B6D4" : theme.textSec,
